...
//        FloatingActionButton buttonAddFCustomer = findViewById(R.id.button_add_note);
//        buttonAddFCustomer.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(MainActivity.this, AddEditFCustomerActivity.class);
//                startActivityForResult(intent, ADD_NOTE_REQUEST);
//            }
//        });

//        adapter.setOnItemClickListener(new FCustomerAdapter.OnItemClickListener() {
//            @Override
...
//        });
        ...
        for (FCustomer fCustomer: fCustomerViewModel.getAllFCustomer()) {
...
//        });
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                FCustomer deletedFCustomer = fCustomerViewModel.delete(adapter.getFCustomerAt(viewHolder.getAdapterPosition()));
                mapSource.remove(deletedFCustomer.getId()) ;
                adapter.submitList(new ArrayList<>(mapSource.values()));
                ...
                snackbar.setAction("UNDO", new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        fCustomerViewModel.insert(deletedFCustomer);
                        mapSource.put(deletedFCustomer.getId(), deletedFCustomer);
                        adapter.submitList(new ArrayList<>(mapSource.values()));
                ...
                Toast.makeText(CustomerActivity.this, "FCustomer deleted", Toast.LENGTH_SHORT).show();
            }
...
//            FCustomer domain = (FCustomer) data.getSerializableExtra(AddEditFCustomerActivity.DOMAIN);
//            noteViewModel.insert(domain);
//            Toast.makeText(this, "FCustomer saved", Toast.LENGTH_SHORT).show();
//        } else if (requestCode == EDIT_NOTE_REQUEST && resultCode == RESULT_OK) {
//            int id = data.getIntExtra(AddEditFCustomerActivity.EXTRA_ID, -1);
//            if (id == -1) {
//                Toast.makeText(this, "FCustomer can't be updated", Toast.LENGTH_SHORT).show();
//                return;
//            }
//            FCustomer domain = (FCustomer) data.getSerializableExtra(AddEditFCustomerActivity.DOMAIN);
//            domain.setId(id);
//            noteViewModel.update(domain);
//            Toast.makeText(this, "FCustomer updated", Toast.LENGTH_SHORT).show();
//        } else {
//            Toast.makeText(this, "FCustomer not saved", Toast.LENGTH_SHORT).show();
//        }
    }

    public void formAddEditShow(FCustomer note){
//        Intent intent = new Intent(MainActivity.this, AddEditFCustomerActivity.class);
//        intent.putExtra(AddEditFCustomerActivity.EXTRA_ID, note.getId());
//        intent.putExtra(AddEditFCustomerActivity.DOMAIN, note);
//        startActivityForResult(intent, EDIT_NOTE_REQUEST);
    ...
    void syncronizeWithRestServer(){
        ...
        for (FCustomer domain: serviceRest.getAllFCustomerByDivision(userActive.getFdivisionBean())) {
